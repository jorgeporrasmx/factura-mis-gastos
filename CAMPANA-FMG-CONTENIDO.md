# FMG — contenidos listos para aprobar/publicar

## Guion demo 60 segundos

Pantalla: landing de FMG + portal/flujo de recibos.
...
La activación va incluida para los primeros 5. Si quieres probarlo, mándame un recibo que normalmente se te perdería y te enseño cómo quedaría ordenado.

## Mensaje corto para WhatsApp directo — requiere aprobación
...
Cada ticket que se queda en WhatsApp puede ser una deducción perdida.
...
Tu contador no puede deducir lo que nunca le entregas.
...
No necesitas otro Excel para tus gastos.

Necesitas que cada comprobante llegue al lugar correcto antes de que cierre el mes.

Factura Mis Gastos recibe tus tickets, los ordena, da seguimiento a lo facturable y deja un registro claro para tu contador.

## Post 4

Si tienes un negocio chico, probablemente no estás perdiendo dinero por gastar mal.

Estás perdiendo dinero porque no documentas bien lo que ya gastaste.

Un ticket no facturado, una foto perdida o una factura que nunca se pidió terminan saliendo caros.

FMG ayuda a cerrar esa fuga.

## Post 5

Estamos buscando 5 clientes fundadores para FMG.

Perfil ideal:
- negocio con gastos frecuentes
- tickets en WhatsApp/fotos
- contador externo
- cierre mensual desordenado

Oferta fundador: activación incluida y precio preferente por 3 meses.

## Anuncio principal Meta
...
Título:
Convierte recibos en deducciones
...
Título:
Ordena tus gastos este mes

CTA:
Enviar WhatsApp

## Público sugerido Meta

Campaña 1 — frío básico:
- México
- 28-55 años
- intereses: emprendimiento, PyME, SAT, contabilidad, facturación electrónica, administración de empresas, contador público, QuickBooks, Alegra, Aspel, CONTPAQi
- presupuesto: $70/día

Campaña 2 — retargeting:
- visitantes web / interacción redes si está disponible
- presupuesto: $30/día

Total: $100/día por 30 días = $3,000 MXN.
