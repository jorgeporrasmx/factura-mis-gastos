...
const WHATSAPP_MESSAGE = 'Hola, me interesa conocer más sobre Factura Mis Gastos';
...
export function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Options panel */}
      {isOpen && (
        <div className="absolute bottom-16 right-0 bg-white rounded-xl shadow-2xl border border-slate-200 p-4 w-64 animate-fade-in">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div>
                <p className="font-medium text-slate-800">Agendar llamada</p>
                <p className="text-xs text-slate-500">Te contactamos</p>
              </div>
            </button>
          </div>
        </div>
