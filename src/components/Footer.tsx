          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.linkedin.com/company/factura-mis-gastos/about/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors" aria-label="LinkedIn">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
