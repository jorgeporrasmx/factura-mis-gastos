# FMG — Campaña primeros 5 clientes
...
Dueños de micro/pequeñas empresas en México que pagan contador externo y tienen tickets/facturas dispersas.

Prioridad:
1. Negocios con muchos tickets pequeños: gasolina, comidas, herramientas, insumos, mantenimiento, traslados.
2. Dueños que usan WhatsApp para todo.
3. Empresas sin ERP ni equipo administrativo sólido.
4. Quien ya siente dolor mensual con el contador.

Sectores:
- talleres y servicios técnicos
- construcción/remodelación chica
- restaurantes/cafeterías
- gimnasios/estudios
- consultorios
- agencias/eventos/producción
- inmobiliarias chicas
- flotillas pequeñas

## Producto fundador
**FMG Control de Recibos — Cliente Fundador**
...
Precio sugerido:
- $999/mes hasta 30 comprobantes
- $1,499/mes hasta 75 comprobantes
- exceso o volumen: cotización

Oferta primeros 5:
- activación incluida
- revisión del primer lote de recibos
...
## Funnel mínimo
1. Contenido/post/anuncio lleva a landing o WhatsApp.
2. Usuario manda foto o llena formulario.
3. Lead queda en Monday.
4. Respuesta automática pide datos mínimos:
   - nombre
   - tipo de negocio
   - RFC/datos fiscales si quiere facturación
   - volumen aproximado de comprobantes al mes
   - contador: sí/no
5. Si califica, enviar link de pago.
...
2. ¿Cuántos comprobantes manejas al mes aprox.?
3. ¿Ya tienes contador?

### Día 1 — prueba visual
Ayer te escribimos por FMG.
...
### Día 3 — urgencia suave
Cierre de mes llega rápido.

Si tus comprobantes viven en fotos, chats o tickets físicos, tu contador solo puede trabajar con una parte de tus gastos reales.

Estamos activando 5 clientes fundadores con setup incluido. Si quieres entrar, responde “FMG” y revisamos tu caso.

### Día 5 — cierre
Último mensaje sobre FMG.
...
Título: Convierte recibos en deducciones
CTA: Enviar WhatsApp

### Anuncio 2 — dinero perdido
Texto:
...
Título: Deja de perder deducciones
CTA: Enviar WhatsApp

### Anuncio 3 — simplicidad
Texto:
...
1. La mayoría de los negocios no pierde deducciones por falta de contador. Las pierde porque los comprobantes nunca llegan ordenados.

2. WhatsApp es buenísimo para mandar tickets. Malísimo para encontrarlos al cierre del mes.
...
8. Si hoy tienes tickets de gasolina, comidas o compras que probablemente no vas a facturar, FMG puede pagarse solo.
...
- Crear botón directo a WhatsApp con texto prellenado.
- Grabar Loom de 60 segundos mostrando recibo → Drive → Monday.
- Publicar 3 posts por semana durante 4 semanas.
- Correr $100/día en Meta durante 30 días.
- Usar retargeting si hay pixel/audiencia disponible.
- Mensaje directo solo a contactos tibios de alto potencial, con texto aprobado por Jorge.
